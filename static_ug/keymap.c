...
// 32x52 Fibonacci spiral (squares + arcs, Wikipedia-style), row-major MSB-first
#define FIB_SPIRAL_H 52
static const uint8_t PROGMEM fib_spiral_pixels[208] = {
    0xFF, 0xFF, 0xFF, 0xFF,
    0x80, 0x18, 0x00, 0x01,
    0x80, 0x18, 0x00, 0x01,
    0x80, 0x18, 0x00, 0x01,
...
static void render_slave(void) {
    ...
    // Fibonacci spiral centered in the lower half (y=54-105, 52 px tall)
